...
def get_arguments():
    ...
    args.add_argument('-w', '--weight_path', help='link to weight path', default="./weights/yolov3-1c-6000-maxsteps_last.weights")
    ...
    args.add_argument('-cf', '--config_path', help='link to config path', default="./cfg/yolov3-1c-6000-maxsteps.cfg")
    args.add_argument('-n', '--classes_path', default="./cfg/obj.names")
